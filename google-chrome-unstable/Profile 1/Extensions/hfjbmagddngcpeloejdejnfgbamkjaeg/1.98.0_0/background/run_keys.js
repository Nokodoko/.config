...
e.$t=e.parseEmbeddedOptions=e.runKeyInSeq=e.parseKeySeq=e.runKeyWithCond=void 0,r=r,s=Math.abs,
c=["expect","keys","options","mask"],p=0,v=function(n){var e,t,o=r.pn(),u=[],i=""
...
;if(void 0===y&&(y=n.host=null!=n.url?n.url:null,delete n.url),"string"==typeof y&&(y=n.host=i.ot(y)),null!=y){
if(s=void 0,
null!=(a=l.url)||(3===y.t?!["/*","*"].includes(y.v.pathname)||"*"!==y.v.search||"*"!==y.v.hash:2!==y.t||(s=y.v.indexOf("/",y.v.indexOf("://")+3))!==y.v.length-1&&-1!==s)||(a=(c=(null===(f=t.z.get(t.N?t.N.s.Hn:t.L))||void 0===f?void 0:f.Sn)||t.N)?c.s.fr:null),
null==a&&(a=u.Rn(null,true))instanceof Promise)return a.then(function(n){var r
;l.url=n||(t.N?((null===(r=t.z.get(t.N.s.Hn))||void 0===r?void 0:r.Sn)||t.N).s.fr:""),e.runKeyWithCond(l)}),0
;if(!i.ut(y,a))return 1}if(null!=d){if(!t.N&&false!==d)return 1;if("string"==typeof d&&(d=n.iframe=i.ot(d)||true),
"boolean"==typeof d){if(d!==!!(t.N&&t.N.s.Dn))return 1}else if(!i.ut(d,t.N.s.fr))return 1}if(null==k);else{
...
classList:r.tn(t>=0?n.slice(t+1,e>t?e:o):"")}),"*"===n||n.includes(" ")})?(p.length=0,"*"):p),v=l.element,p.length)){
...
return 2!==n.length?null:{env:n[0],keys:e(n[1]),options:null}}))),t=t.map(function(n){
...
var r,o,i,l,b,g,$,_,j,h,z,A,O,w,x,N,T,M,q,I=s(t.V),S=t.z.get(t.N?t.N.s.Hn:t.L);for(i of(t.N||(t.N=S?S.Qn:null),
n=n||t.Ie||{},t.Ie=null,o=d(t.Be)))if(i){if("string"==typeof(b=l=i.env)){
if(!f.bt)return void u.showHUD("No environments have been declared")
;if(void 0===(b=f.bt.get(b)))return void u.showHUD('No environment named "'.concat(l,'"'))
;if("string"==typeof b&&(b=f.dt(b,2),f.bt.set(l,b)),null===b)continue}if(0===(g=y(b,n)))return;if(2===g){r=i;break}}
if($=r?r.keys:t.Be.keys,h=r?"string"==typeof r.env?"[".concat(r.env,"]: "):"(".concat(o.indexOf(r),")"):"",
0===$.length)u.showHUD(h+"Require keys: comma-seperated-string | string[]");else if(I>$.length&&1!==$.length)u.showHUD(h+"Has no such a key");else if((_=$[j=1===$.length?0:t.V>0?I-1:$.length-I])&&("string"==typeof _||"object"==typeof _&&_.tree&&"object"==typeof _.tree&&"number"==typeof _.tree.t)){
if(z=1===$.length?t.V:1,"string"==typeof _){if(null!=(A=t.Be.mask)){
...
;N=r&&r.options||t.Be.options||(t.Be.$masked?null:v(t.Be)),N=a.concatOptions(N,x),T=p=(p+1)%64||1,
M="<v-runkey:$1>".replace("$1",""+T),w.val.length>1||0!==w.val[0].t?(q={$seq:{keys:w,repeat:z,options:N,cursor:w,
timeout:0,id:M,fallback:a.parseFallbackOptions(t.Be)},$then:M,$else:"-"+M,$retry:-999},a.replaceCmdOptions(q),
t.R.set(M,f.st("runKey",q)),e.runKeyInSeq(q.$seq,1,null,n)):m(w.val[0],{keys:w,repeat:z,options:N,cursor:w,timeout:0,
...
return 1===n.length&&s.val.push({t:0,val:n,par:s}),r.wn(),s},g=function(n,e){var t,r,o=true,u=n
...
var i,f,s=g(n.cursor,e),c=s&&g(s,1),v=s&&g(s,-1),y=!(s&&(c||v)),d=n.fallback,k=t.Be,b=n.id;if(y&&(t.R.delete(b),
...
k=t.Be),1&i&&(k.$then="$l+"+k.$then),2&i&&(k.$else="$l+"+k.$else)),f=y?0:n.timeout=setTimeout(function(){
var n=t.R.get(b),e=n&&n.gt;e&&e.$seq&&e.$seq.timeout===f&&t.R.delete(b)},3e4),m(s,n,o);else{
if(d&&(d.$f?d.$f.t=r&&r.t||d.$f.t:d.$f=r,a.runNextCmdBy(e>0?1:0,d,1)))return
;e<0&&r&&r.t&&u.showHUD(l.gr("".concat(r.t)))}},$=function(n){var t,r,o,u,i,l,f,a,s=n.val
...
var e=n.split("=",1)[0],t=n.slice(e.length);return e+(t?"="+l(r.cn(t.slice(1))):"")}).join(" "),
u&&(n=(n?n+" ":"")+(e=u.split("=",1)[0])+((t=u.slice(e.length))?"="+l(t.slice(1)):"")),f.dt(n,2)},m=function(n,e,t){
var r=$(n),o=e.cursor===e.keys,u=o||r.prefix.includes("$c"),i=a.concatOptions(e.options,r.options);e.cursor=n,
j(r.key,r.count*(u?e.repeat:1),i,t,null,o)},t.j=function(n,e,r){var o,u,i,l,f
...
!t.R.has(f)&&!/^[a-z]+(\.[a-z]+)?$/i.test(f)););t.N=e,t.B=0,t.Be=null,j(l?n.slice(0,l-1):n,u,l?n.slice(l):null,null,r)},
_=function(n){for(var e=t.Be;e&&e!==n;)e=e.$o;return e===n},j=function(n,o,i,l,s,c){
var p,v,y,d,k,b=n,g="__proto__"!==n&&t.R.get(n)||!n.includes("<")&&t.R.get(b="<v-".concat(n,">"))||null,$=true
;null==g&&n in f.it&&($=false,
g=f.st(n,null)),null!=g?36===g.wt&&g.ht&&g.gt&&"object"==typeof g.gt&&_(g.gt)?u.showHUD('"runKey" should not call itself'):("string"==typeof i&&(i=i?e.parseEmbeddedOptions(i):null),
v=(p=t.Be)&&a.parseFallbackOptions(p),y=p&&p.$f,(i&&"object"==typeof i||v||y)&&(d=f.ct(g),g=$?Object.assign({},g):g,
k=r.pn(),i&&a.copyCmdOptions(k,r.mn(i)),v&&a.copyCmdOptions(k,r.mn(v)),d&&a.copyCmdOptions(k,d),k.$f=y,
i&&"$count"in i?k.$count=i.$count:d&&"$count"in d&&(i&&"count"in i||(k.$count=d.$count)),g.gt=k,
2!==g.wt||g.ht||(g.ft=0),f.lt(g)),r.wn(),c&&36===g.wt&&g.ht?setTimeout(function(){t.Ie=l,
a.executeCommand(g,o,t.B,t.N,0,s)
},0):(t.Ie=l,a.executeCommand(g,o,t.B,t.N,0,s))):u.showHUD('"'.concat(/^\w+$/.test(n)?b:n,'" has not been mapped'))},
e.$t=function(n){var e,o,u,i,l,s,p,y,b,m,_,j,h=f.ct(n);if(h||(h=n.gt=r.pn()),2===h.$normalized)return n.Tt;for(o=true,
d(e=h),e.$normalized=2;e&&0===d(e).length&&e.keys.length>=1;){if(o=o&&1===e.keys.length,
"string"==typeof(i=(u=e.keys)[0])){if(null!=(l=e.mask)){if(e!==h&&(e=h=a.concatOptions(e,h)),
!(s=a.fillOptionWithMask(i,l,"",c,1,h)).ok)return;l=s.ok>0,i=s.result,o=o&&!!s.value&&!s.useCount&&!s.useDict}i=k(i),
l||(u[0]=i)}if(!(p=1===i.tree.t?g(i.tree,1):null))return;if(o=o&&1===i.tree.val.length&&i.tree.val[0]===p,y=$(p),
!(_=(m=t.R.get(b=y.key)||!b.includes("<")&&t.R.get("<v-".concat(b,">"))||null)?m.Tt:b in f.it?b:null))return
;if(((j=null!=m&&36===m.wt&&m.ht)||o)&&(e!==h&&(e=h=a.concatOptions(e,h)),h=h.options||(h.$masked?null:v(h)),
h=a.concatOptions(a.concatOptions(h,i.options),y.options)),!j)return o?Object.assign(n,f.st(_,h)):n.Tt=_,_
